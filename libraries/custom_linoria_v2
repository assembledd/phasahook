...
local CoreGui = gethui and gethui() or RefService('CoreGui');
...
function Library:Unload()
	for i,v in Toggles do v:SetValue(false) end
...
function Library:CreateWindow(...)
	...
	local function update()
		...
		if c > 0 then
			...
			TabListLayout.CellSize = UDim2.new(Width / TabArea.AbsoluteSize.X / c, 0, 0, TabListLayout.CellSize.Y.Offset)
		end
	end
    ...
    function Window:AddTab(Name)
        ...
        local LeftSide = Library:Create('ScrollingFrame', {
            ...
            Size = UDim2.new(0.333333333333, -10, 0, 507 + 2);
            CanvasSize = UDim2.new(0, 0, 0, 0);
            BottomImage = '';
            TopImage = '';
        ...
        local MiddleSide = Library:Create('ScrollingFrame', {
            BackgroundTransparency = 1;
            BorderSizePixel = 0;
            Position = UDim2.new(0.34, 0.5, 0, 7);
            Size = UDim2.new(0.333333333333, -10, 0, 507 + 2);
            CanvasSize = UDim2.new(0, 0, 0, 0);
            BottomImage = '';
            TopImage = '';
        ...
        function Tab:AddGroupbox(Info)
            ...
            local BoxOuter = Library:Create('Frame', {
                ...
                ZIndex = 2;
                Parent = Info.Side == 1 and LeftSide or Info.Side == 2 and MiddleSide or RightSide;
            });
